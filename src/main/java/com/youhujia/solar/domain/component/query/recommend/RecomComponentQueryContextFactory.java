 ...
 */
@Component
public class RecomComponentQueryContextFactory {

    @Autowired
    HDFragmentsServiceWrap hdFragmentsServiceWrap;

    public RecomComponentQueryContext buildRecomComponentQueryContext(HDFragments.TagDTO tagDTO) {
        ...
        context.setRecomComponentDTO(transform2RecomComponentDTO(tagDTO.getData().getTag(),tagPropertiesDTO));
        return context;
    }
